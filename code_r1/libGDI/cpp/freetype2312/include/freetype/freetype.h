...
// #ifndef <freetype/freetype.h>
// #error "`ft2build.h' hasn't been included yet!"
// #error "Please always use macros to include FreeType header files."
// #error "Example:"
// #error "  #include <ft2build.h>"
// #error "  #include <freetype/freetype.h>"
// #endif
...
#define FT_IS_SCALABLE( face ) \
   ...
   *   bitmap fonts.
   *
   *   If this macro is true, all functions defined in @<freetype/ftsnames.h> and
   *   @<freetype/tttables.h> are available.
   *
   */
...
#define FT_HAS_GLYPH_NAMES( face ) \
   ...
   * @description:
   *   A macro that returns true whenever a face object contains some
   *   multiple masters.  The functions provided by @<freetype/ftmm.h>
...
#define FT_HAS_MULTIPLE_MASTERS( face ) \
   ...
   *   details.
   *
   *   If this macro is true, all functions defined in @<freetype/ftcid.h> are
   *   available.
   *
   */
